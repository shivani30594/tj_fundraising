<head>
    ...
    <link href="<?php echo ASSETS ?>global/css/style.css?<?php echo date('l jS \of F Y h:i:s A');?>" rel="stylesheet"><!--bootstrap css-->
    <link rel="stylesheet" href="<?php echo ASSETS ?>global/css/intlTelInput.css"><!--Input tel css-->
    <link href="<?php echo ASSETS ?>global/css/responsive.css?<?php echo date('l jS \of F Y h:i:s A');?>" rel="stylesheet"><!--bootstrap css-->
    <link href="<?php echo ASSETS ?>global/css/sweetalert2.min.css" rel="stylesheet"><!--bootstrap css-->
    <link href="<?php echo ASSETS ?>global/css/multiple-emails.css" rel="stylesheet"><!--bootstrap css-->
    <link href="<?php echo ASSETS ?>global/css/datatables.min.css" rel="stylesheet"><!--bootstrap css-->

            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="menu-wrap">
                            <ul class="navigation">
                                <li class="single-logout"><a href="<?php echo BASE_URL?>u_logout">Logout</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <form id="create_campaign_form" action="<?php echo BASE_URL?>user/campaign/create_campaign" method="POST" enctype="multipart/form-data">
                                <div class="col-md-4 col-sm-4">
                                    <div class="tg-input-grp">
                                        <label for="tg-org-name">Organization/Individual</label>
                                        <input type="text" name="group_name" class="tg-input" data-toggle="tooltip" title="Your name or group name here!">
                                    </div>
                                    <div class="tg-input-grp">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="tg-input-grp tg-input-date">
                                        ...
                                        <small>Please allow xx days after end date for TJS PIZZA to issue you a check for your portion of funds raised</small>
                                    ...
                                    <div class="tg-input-grp">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-content">
                                                <ul>
                                                    <li><a href="javascript:void(0);" style="font-size: 15px;color:white">Pick Up</a></li>
                                                    <li><a href="javascript:void(0);" style="font-size: 15px;color:white">Ship</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div id="selectGroup" data-backdrop="static" data-keyboard="false" class="modal fade cust-modal" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form action="<?php echo BASE_URL?>user/dashboard/set_status" method="POST">

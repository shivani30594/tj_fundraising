        ...
        <div class="col-md-12">
            <div class="portlet light ">
                <div class="portlet-body">
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="paypal_datatable" style="border-bottom: 0px !important; width: 1319px;">
                    </table> 
                </div>
            </div>
        </div>
